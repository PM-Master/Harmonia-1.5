...
public class PmNode implements Serializable {
    ...
    public PmNode(String[] args, ChildProvidingDelegate<PmNode> providingDelegate) {
        this(getOrElse(args, 0, ""),getOrElse(args, 1, ""), getOrElse(args, 2, ""), providingDelegate);
    }
    ...
    public PmNode(String sType, String sId, String sLabel, ChildProvidingDelegate<PmNode> providingDelegate) {

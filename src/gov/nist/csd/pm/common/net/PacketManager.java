		...
		try {
			...
			if (payloadLength == 0) {
				...
				if (itemType != ItemType.BINARY) {
					...
					System.out.println("BEFORE THE fOOR LOOP IN THE NON BIN");
					for (;;) {
...
System.out.println("Successfully received packet: " + packetBytes.length + " bytes");
					...
					if (outputStream == null) {
						System.out.println("THE NULL OUTPOT STREAM ERRO");
					...
					System.out.println("ITEMS TO INT");
					...
					System.out.println("WE PASSSED ALL");
                    outputStream.flush();
                    outputStream.close();
                    packet = new Packet();

...
set CLASSPATH=%PM_ROOT%\dist\pm-user-1.5.jar;%PM_ROOT%\dist\pm-exporter-1.5.jar;%PM_ROOT%\dist\pm-commons-1.5.jar;%PM_ROOT%\lib\activation-1.1.jar;%PM_ROOT%\lib\aopalliance-1.0.jar;%PM_ROOT%\lib\asm-3.1.jar;%PM_ROOT%\lib\bcmail-jdk15-1.44.jar;%PM_ROOT%\lib\bcprov-jdk15-1.44.jar;%PM_ROOT%\lib\cglib-2.2.1-v20090111.jar;%PM_ROOT%\lib\colorchooser-1.0.jar;%PM_ROOT%\lib\commons-logging-1.1.1.jar;%PM_ROOT%\lib\fontbox-1.6.0.jar;%PM_ROOT%\lib\guava-r09.jar;%PM_ROOT%\lib\guice-3.0.jar;%PM_ROOT%\lib\icu4j-3.8.jar;%PM_ROOT%\lib\jarjar-1.0.jar;%PM_ROOT%\lib\javax.inject-1.jar;%PM_ROOT%\lib\javax.mail-1.4.4.jar;%PM_ROOT%\lib\jempbox-1.6.0.jar;%PM_ROOT%\lib\jfontchooser-1.0.5-pm.jar;%PM_ROOT%\lib\jna-3.2.7-pm-platform.jar;%PM_ROOT%\lib\jna-3.2.7-pm.jar;%PM_ROOT%\lib\jsr305-1.3.7.jar;%PM_ROOT%\lib\miglayout-3.7.3.1-swing.jar;%PM_ROOT%\lib\pdfbox-1.6.0.jar;%PM_ROOT%\lib\wrapper-3.2.3.jar;%PM_ROOT%\lib\wrapper.jar;%PM_ROOT%\lib\mysql-connector-java-5.1.31-bin.jar

...
#Policy class creation, PM is the root from which all Policy Classes derive
add|p|MLS|c|PM
...
#I think these parts are related to mec records account management, but maybe just account management in general
...
#Adding users to DAC user group
...
#Define Roles
asg|a|Adm Clerk|p|Workflow
asg|a|Accts Pbl|p|Workflow
asg|a|Contracting|p|Workflow
asg|a|Accts Rcv|p|Workflow
asg|a|Acquisition|p|Workflow
asg|a|Secretary|p|Workflow
asg|a|Intern|p|Workflow
add|a|Workflow uattrs|p|Workflow
asg|a|David|a|Workflow uattrs
asg|a|Katherine|a|Workflow uattrs
asg|a|Charles|a|Workflow uattrs
asg|a|Robert|a|Workflow uattrs
asg|a|Alicia|a|Workflow uattrs
asg|a|Exporter|a|Workflow uattrs
add|ob|Workflow uattrs rep|User attribute|yes|DAC uattrs|A7E1D543C7EDE55B428047BFAA6F096A|p|Workflow


#Roles for fields

asg|a|David|p|Workflow Fields
asg|a|Katherine|p|Workflow Fields
asg|a|Charles|p|Workflow Fields
asg|a|Robert|p|Workflow Fields
asg|a|Alicia|p|Workflow Fields
asg|a|Exporter|p|Workflow Fields


#Workflow - "reps" for well-known locations that provide initial/terminal points for started/completed/rejected workflows
#These are placed under the RBAC policy class because my understanding is that access rights are determined by the union
#of assigned policy classes.
add|ob|Blank Forms rep|Object attribute|yes|Blank Forms|C6FAE128F13E4C90ACC6E66036A4E747|p|Workflow
add|ob|Populated Forms rep|Object attribute|yes|Populated Forms|C6FAE128F13E4C90ACC6E66036A4E746|p|Workflow
add|ob|Rejected Forms rep|Object attribute|yes|Rejected Forms|A7ADA5717555D189EAEDC13368EF9068|p|Workflow
add|ob|Completed Forms rep|Object attribute|yes|Completed Forms|1D417040F4386F420FEBEC3CB8C6DA42|p|Workflow

add|ob|Signatures rep|Object attribute|yes|Signatures|C6FAE128F13E4C90ACC6E66036A4E748|p|Workflow Fields
add|ob|alice Signatures rep|Object attribute|yes|alice Signatures|A7ADA5717555D189EAEDC13368EF9069|p|Workflow Fields
add|ob|bob Signatures rep|Object attribute|yes|bob Signatures|1D417040F4386F420FEBEC3CB8C6DA43|p|Workflow Fields
add|ob|charlie Signatures rep|Object attribute|yes|charlie Signatures|A7ADA5717555D189EAEDC13368EF9073|p|Workflow Fields
add|ob|dave Signatures rep|Object attribute|yes|dave Signatures|1D417040F4386F420FEBEC3CB8C6DA44|p|Workflow Fields
add|ob|katie Signatures rep|Object attribute|yes|katie Signatures|A7ADA5717555D189EAEDC13368EF9070|p|Workflow Fields

add|ob|Rejections rep|Object attribute|yes|Rejections|C6FAE128F13E4C90ACC6E66036A4E749|p|Workflow Fields
add|ob|alice Rejections rep|Object attribute|yes|alice Rejections|A7ADA5717555D189EAEDC13368EF9074|p|Workflow Fields
add|ob|bob Rejections rep|Object attribute|yes|bob Rejections|1D417040F4386F420FEBEC3CB8C6DA45|p|Workflow Fields
add|ob|charlie Rejections rep|Object attribute|yes|charlie Rejections|A7ADA5717555D189EAEDC13368EF9071|p|Workflow Fields
add|ob|dave Rejections rep|Object attribute|yes|dave Rejections|1D417040F4386F420FEBEC3CB8C6DA46|p|Workflow Fields
add|ob|katie Rejections rep|Object attribute|yes|katie Rejections|A7ADA5717555D189EAEDC13368EF9072|p|Workflow Fields


#For Workflow - Well-known locations for completed, rejected, blank, and populated forms
add|b|Completed Forms|p|Workflow
add|prop|homeof=Completed Forms|b|Completed Forms
add|b|Rejected Forms|p|Workflow
add|prop|homeof=Rejected Forms|b|Rejected Forms
add|b|Blank Forms|p|Workflow
...
add|b|Signatures|p|Workflow Fields
add|prop|homeof=signatures|b|Signatures
add|b|Rejections|p|Workflow Fields
add|prop|homeof=rejections|b|Rejections

add|b|alice Signatures|b|Signatures
add|prop|signaturesfor=alice|b|alice Signatures
add|b|bob Signatures|b|Signatures
add|prop|signaturesfor=bob|b|bob Signatures
add|b|charlie Signatures|b|Signatures
add|prop|signaturesfor=charlie|b|charlie Signatures
add|b|dave Signatures|b|Signatures
add|prop|signaturesfor=dave|b|dave Signatures
add|b|katie Signatures|b|Signatures
add|prop|signaturesfor=katie|b|katie Signatures

add|b|alice Rejections|b|Rejections
add|prop|rejectionsfor=alice|b|alice Rejections
add|b|bob Rejections|b|Rejections
add|prop|rejectionsfor=bob|b|bob Rejections
add|b|charlie Rejections|b|Rejections
add|prop|rejectionsfor=charlie|b|charlie Rejections
add|b|dave Rejections|b|Rejections
add|prop|rejectionsfor=dave|b|dave Rejections
add|b|katie Rejections|b|Rejections
add|prop|rejectionsfor=katie|b|katie Rejections



add|b|witems|p|Workflow
add|prop|containerof=witems|b|witems


#Declaration of privileges for all DAC uattrs to put object attributes into well-known workflow containers
add|s|D31DD406|oc|Ignored|a|Secretary
...
add|s|D31DD407|oc|Ignored|a|Workflow uattrs
add|op|Object attribute assign to|s|D31DD407
add|s|D31DD408|oc|Ignored|a|Workflow uattrs
add|op|Object attribute assign to|s|D31DD408
add|s|D31DD409|oc|Ignored|a|Workflow uattrs
add|op|Object attribute create object|s|D31DD409
add|op|Object attribute create object attribute|s|D31DD409



#Assigning privliges to Rep objects for well-know workflow containers
...
#Assigning privleges to read,write files in workflow containers
#RM - this is not enforcing as it should it will have to be more restrictive.
#read write privileges will have to be assigned dynamically on workflow instance creation
add|s|48A4EB15|oc|Ignored|a|Workflow uattrs
add|op|Dir read|s|48A4EB15
add|op|File read|s|48A4EB15
asg|s|48A4EB15|b|Blank Forms

add|s|48A4EB16|oc|Ignored|a|Workflow uattrs
add|op|Dir read|s|48A4EB16
add|op|File read|s|48A4EB16
asg|s|48A4EB16|b|Rejected Forms

add|s|48A4EB17|oc|Ignored|a|Workflow uattrs
add|op|Dir read|s|48A4EB17
add|op|File read|s|48A4EB17
asg|s|48A4EB17|b|Completed Forms

add|s|48A4EB18|oc|Ignored|a|Workflow uattrs
add|op|Dir read|s|48A4EB18
add|op|File write|s|48A4EB18
asg|s|48A4EB18|b|Populated Forms

add|s|48A4EB19|oc|Ignored|a|Alicia
add|op|File write|s|48A4EB19
asg|s|48A4EB19|b|alice Signatures

add|s|48A4EB21|oc|Ignored|a|Robert
add|op|File write|s|48A4EB21
asg|s|48A4EB21|b|bob Signatures

add|s|48A4EB22|oc|Ignored|a|Charles
add|op|File write|s|48A4EB22
asg|s|48A4EB22|b|charlie Signatures

add|s|48A4EB23|oc|Ignored|a|David
add|op|File write|s|48A4EB23
asg|s|48A4EB23|b|dave Signatures

add|s|48A4EB24|oc|Ignored|a|Katherine
add|op|File write|s|48A4EB24
asg|s|48A4EB24|b|katie Signatures


add|s|48A4EB25|oc|Ignored|a|Alicia
add|op|File write|s|48A4EB25
asg|s|48A4EB25|b|alice Rejections

add|s|48A4EB26|oc|Ignored|a|Robert
add|op|File write|s|48A4EB26
asg|s|48A4EB26|b|bob Rejections

add|s|48A4EB27|oc|Ignored|a|Charles
add|op|File write|s|48A4EB27
asg|s|48A4EB27|b|charlie Rejections

add|s|48A4EB28|oc|Ignored|a|David
add|op|File write|s|48A4EB28
asg|s|48A4EB28|b|dave Rejections

add|s|48A4EB29|oc|Ignored|a|Katherine
add|op|File write|s|48A4EB29
asg|s|48A4EB29|b|katie Rejections




add|s|D7048A1C|oc|Ignored|a|Secretary
add|op|Dir read|s|D7048A1C
...
#Add workflow prototype forms, only PDF forms please!!!
add|ob|Purchase Order Form n114|File|no|pmvm|C:\PMWork\Forms\n114poWsign.pdf|b|Blank Forms
add|ob|PO|File|no|pmvm|C:\PMWork\Forms\poform.wkf|b|Blank Forms
#Add example completed worflow into populated forms
...
asg|b|QuickFlow_FLOW_bob_REJECT|b|bob Rejections
asg|b|QuickFlow_FLOW_bob_SIGN|b|bob Signatures
asg|b|QuickFlow_FLOW_alice_REJECT|b|alice Rejections
asg|b|QuickFlow_FLOW_alice_SIGN|b|alice Signatures

#END WORKFLOW CREATE SECTION
...
add|app|Workflow Editor Old|C:\PM\pm1.4\dist\pm-app-wkf-old-1.5.jar;C:\PM\pm1.4\dist\pm-app-wkf-old-1.5.jar;C:\PM\pm1.4\dist\pm-commons-1.5.jar;C:\PM\pm1.4\lib\activation-1.1.jar;C:\PM\pm1.4\lib\aopalliance-1.0.jar;C:\PM\pm1.4\lib\asm-3.1.jar;C:\PM\pm1.4\lib\bcmail-jdk15-1.44.jar;C:\PM\pm1.4\lib\bcprov-jdk15-1.44.jar;C:\PM\pm1.4\lib\cglib-2.2.1-v20090111.jar;C:\PM\pm1.4\lib\colorchooser-1.0.jar;C:\PM\pm1.4\lib\commons-logging-1.1.1.jar;C:\PM\pm1.4\lib\fontbox-1.6.0.jar;C:\PM\pm1.4\lib\guava-r09.jar;C:\PM\pm1.4\lib\guice-3.0.jar;C:\PM\pm1.4\lib\icu4j-3.8.jar;C:\PM\pm1.4\lib\jarjar-1.0.jar;C:\PM\pm1.4\lib\javax.inject-1.jar;C:\PM\pm1.4\lib\javax.mail-1.4.4.jar;C:\PM\pm1.4\lib\jempbox-1.6.0.jar;C:\PM\pm1.4\lib\jfontchooser-1.0.5-pm.jar;C:\PM\pm1.4\lib\jna-3.2.7-pm-platform.jar;C:\PM\pm1.4\lib\jna-3.2.7-pm.jar;C:\PM\pm1.4\lib\jsr305-1.3.7.jar;C:\PM\pm1.4\lib\miglayout-3.7.3.1-swing.jar;C:\PM\pm1.4\lib\pdfbox-1.6.0.jar;C:\PM\pm1.4\lib\wrapper-3.2.3.jar;C:\PM\pm1.4\lib\wrapper.jar|gov.nist.csd.pm.application.oldworkflow.Wkflow|Workflow old >>|pmvm
